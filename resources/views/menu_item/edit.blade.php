...
@section('title', 'Edit Menu Item - McDonald\'s Management')
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <select name="status" id="status" class="form-control" required>
                    ...
                    <option value="Not Available" {{ old('status', $menuItem->status) == 'Not Available' ? 'selected' : '' }}>Not Available</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            @if($menuItem->image)
                <div style="margin-bottom: 1rem;">
                    <strong style="color: var(--mcdonalds-red);">Current Image:</strong>
                    <br>
            ...
            <small style="color: var(--gray); font-size: 0.875rem; margin-top: 0.5rem; display: block;">
                Supported formats: JPEG, PNG, JPG. Maximum size: 4MB. Leave empty to keep current image.
            </small>
        </div>

        <div style="display: flex; gap: 1rem; justify-content: center; margin-top: 2rem; flex-wrap: wrap;">
            <button type="submit" class="btn btn-primary">Update Menu Item</button>
            <a href="{{ route('menu_items.show', $menuItem) }}" class="btn btn-secondary">View Item</a>
